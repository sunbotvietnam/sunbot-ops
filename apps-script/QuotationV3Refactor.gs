const QUOTATION_V3 = Object.freeze({
  SHEETS:Object.freeze({CATALOG:'CATALOG_ITEMS',PRICES:'PRICE_VERSIONS',COMBOS:'COMBO_DEFINITIONS',COMPONENTS:'COMBO_COMPONENTS',RULES:'PRICING_RULES',MATERIALS:'MATERIALS',QUOTES:'QUOTES',LINES:'QUOTE_LINES',AUDIT:'AUDIT_LOG'}),
  HEADER_ROW:3,
