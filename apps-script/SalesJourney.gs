...
function journeyTemplate_(user,scenario,row,profileUrl) {
  ...
  const profileLine = '\n\nEm xin phép gửi Ban Giám hiệu E-profile Sunbot để tiện tham khảo:\n' + profileUrl;
  ...
  if (scenario === 'CURRENT') return {
    ...
    message:'Em xin phép gửi Ban Giám hiệu E-profile Sunbot cập nhật cho năm học mới: ' + profileUrl + '. Sunbot mong được trao đổi online khoảng 30–40 phút về kế hoạch và nhu cầu triển khai của Nhà trường.'
  };
  ...
  if (scenario === 'FORMER') return {
    ...
    message:'Em xin phép gửi Ban Giám hiệu E-profile Sunbot cập nhật: ' + profileUrl + '. Vì Nhà trường đã từng triển khai Sunbot, bên em rất mong có một buổi online khoảng 30–40 phút để cập nhật chương trình và trao đổi nhu cầu năm học mới.'
  };
  ...
  if (scenario === 'KNOWN') return {
    ...
    message:'Em xin phép gửi Ban Giám hiệu E-profile Sunbot cập nhật: ' + profileUrl + '. Nếu Nhà trường vẫn quan tâm đến STEAM, công nghệ hoặc các hoạt động phát triển tư duy cho trẻ, bên em mong được trao đổi online khoảng 30–40 phút để cập nhật nhu cầu hiện tại.'
  };
