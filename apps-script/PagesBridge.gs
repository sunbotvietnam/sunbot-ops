...
const SUNBOT_PAGES_BRIDGE_VERSION = '2026-09-13-v31-school-profile-master';
function handlePagesBridge_(e){
  ...
  try{
    ...
    else if(mode==='v2Profile') result=apiSessionV2Profile(token,String(p.subaction||''),payload);
