...
const SUNBOT_PAGES_BRIDGE_VERSION = '2026-09-23-v35-opportunity-gate';
function handlePagesBridge_(e){
  ...
  try{
    ...
    else if(mode==='v2Opportunity') result=apiSessionV2Opportunity(token,String(p.subaction||''),payload);
